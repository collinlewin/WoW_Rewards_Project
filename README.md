...
Over the past decade, I have developed statistical models and artificial intelligence/machine learning algorithms, contributing to NASA mission success and advancing our understanding of black holes and materials. Similar to reward systems, these data-driven algorithms boil down to maximizing a statistic that encourages the model to best perform its goal. In the way that I designed a statistical system to teach robots to navigate an obstacle-rich environment by rewarding obstacle avoidance, I aim to create systems that enhance player engagement and ensure the best possible experience in World of Warcraft. Outside of work, I create board games with my partner and write fantasy stories. This project demonstrates me applying my professional skills and passion for game design to show my current understanding of rewards systems in a game I am incredibly passionate about. I am nonetheless very excited and open to learning more through collaboration.
